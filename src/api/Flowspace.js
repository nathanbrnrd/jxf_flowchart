        ...
        if (pa && pb) {
          ...
          paths.push(
            <path
              ...
              stroke-width={parseInt(connection.width) + (isSelectedLine ? 3 : 0)}
          ...
          gradients.push(
            <linearGradient
              ...
              <stop offset="0" stop-color={connection.outputColor}/>
              <stop offset="1" stop-color={connection.inputColor}/>
            </linearGradient>
          )
        }
      })
